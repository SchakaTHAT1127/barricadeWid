...
ENT.PrintName = "sandbag wall" -- The name that will appear in the spawn menu.
ENT.Author = "Alp Er Tunga" -- The author's name for this Entity.
ENT.Category = "forticiationis" -- The category for this Entity in the spawn menu.
ENT.Purpose = "sandbag wall" -- The purpose of this Entity.
